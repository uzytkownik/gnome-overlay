...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/gnome-screensaver/gnome-screensaver-2.28.3.ebuild,v 1.1 2010/02/14 23:36:49 eva Exp $
...
RDEPEND=">=gnome-base/gconf-2.6.1
	>=x11-libs/gtk+-2.14.0
	>=gnome-base/gnome-desktop-2.29.2
