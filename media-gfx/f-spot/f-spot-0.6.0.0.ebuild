...
# $Header: /var/www/viewcvs.gentoo.org/raw_cvs/gentoo-x86/media-gfx/f-spot/f-spot-0.6.0.0.ebuild,v 1.1 2009/08/11 12:52:18 lack Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-0.5.0.3-dcraw-tiff.patch"
	eautoreconf
}
