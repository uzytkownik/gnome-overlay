...
# $Header: /var/cvsroot/gentoo-x86/net-im/empathy/empathy-2.30.2.ebuild,v 1.3 2010/08/01 11:53:09 fauli Exp $
...
IUSE="gtk3 nautilus networkmanager spell test webkit" # map

# FIXME: libnotify & libcanberra hard deps
RDEPEND=">=dev-libs/glib-2.22.0
	>=x11-libs/gtk+-2.18.0
	>=net-libs/folks-0.1.14
	>=gnome-base/gconf-2
	...
	spell? (
		...
		app-text/iso-codes )
	webkit? (
		gtk3? ( >=net-libs/webkit-gtk-1.3.3 )
		!gtk3? ( >=net-libs/webkit-gtk-1.1.15 ) )"
#	Upstream says not to ship this, or use this.  It is also buggy.
#	tpl? ( >=net-im/telepathy-logger-0.1.2 )
#	map? (
